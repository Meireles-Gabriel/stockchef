                        ...
                        child: Center(
                          child: PopupMenuButton<String>(
                            ...
                            child: SizedBox(
                              ...
                              width: 170,
                              child: Center(
                                child: Text(ref.watch(languageNotifierProvider)[
                                            'language'] ==
                                        'en'
                      ...
                      DefaultButton(
                        ...
                        action: () async {
                          if (nameController.text == '' ||
                            ...
                            showSnackBar(
                                context, ref.watch(itemsProvider).toString());
                            ...
                            // Resolve o Future do itemsProvider para acessar os documentos
                            final itemsSnapshot =
                                await ref.watch(itemsProvider);
                            if (itemsSnapshot != null) {
                              final items = itemsSnapshot.docs;
                              for (var item in items) {
                                if (name == item['name']) {
                                  showSnackBar(
                                      context, texts['create_item'][13]);
                                  return;
                                }
                              }
                            }
                            ...
                            // Resetando estados após adicionar o item
                            ref.read(definedExpirationProvider.notifier).state =
                                true;
                            ref
